...
result <- parLapply(cl = cl, X = 8 + 1:8, fun = run_one_uSCR_simulation_binomial,
                    niter = 6000, nburnin = 1000, nchains = 2, thin = 1,
                    M = 1000, sampler_spec = "RW_block_2", prefix = "sim_validation_")
